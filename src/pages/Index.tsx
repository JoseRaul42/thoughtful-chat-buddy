...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-thoughtful-100 to-white p-4 md:p-8">
      <header className="mb-8 mx-auto max-w-3xl text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-thoughtful-900 mb-2">Thoughtful AI Support</h1>
